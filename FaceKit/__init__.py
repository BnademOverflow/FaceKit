...
class Account:
    ...
    def __init__(self, cookies):
        ...
        self.info = None
        self.session_number = self.__added()
        self.login(cookies)

    def __repr__(self):
        return "<logged: {}, name: {}, id: {}, session_number: {}, info: {}>".format(
            self.__logged, self._name, self._id, self.session_number, self.info
        )
    ...
    def login(self, cookies):
        ...
        html = data.text
        if "?refsrc" not in data.url and "mbasic_logout_button" in html:
    ...
    def __success_login(self, html):
        ...
        self.profile_picture = (
            profile_picture.get("src") if type(profile_picture) == Tag else None
        )
