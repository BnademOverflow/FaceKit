...
def like_post_home(ses, next=None):
    return like_core(
        ses, "https://mbasic.facebook.com/home.php", next, "?aftercursorr="
    )
...
def like_post_friend(ses, id=None, next=None):
    return like_core(
        ses, "https://mbasic.facebook.com/{}?v=timeline".format(id), next, "?cursor"
    )
...
def like_post_fanspage(ses, username=None, next=None):
    return like_core(
        ses,
        "https://mbasic.facebook.com/{}".format(username),
        next,
        "?sectionLoadingID=",
    )
...
def like_post_grup(ses, id=None, next=None):
    return like_core(
        ses, "https://mbasic.facebook.com/groups/{}".format(id), next, "?bacr="
    )
